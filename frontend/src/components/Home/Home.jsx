...
const HomePageBody = () => {
  return (
    ...
    <div className="flex flex-wrap justify-center items-center min-h-screen">
      ...
      {/* Transport */}
      <Link to="/Transport">
        <div className="w-80 h-20 bg-[#000000] m-4 flex justify-center items-center rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
